...
public class Lkfv6XRoadConsumerMessageExtractor extends CustomExtractor {
    private final XmlBeansXRoadMetadata metadata;

    public Lkfv6XRoadConsumerMessageExtractor(XmlBeansXRoadMetadata metadata) {
    ...
    public XRoadMessage<XmlObject> extractData(WebServiceMessage response) throws IOException {
        ...
        try {
            ...
            String textContent = kehaNode.getTextContent();
            if(textContent != null) {
                textContent = textContent.trim();
            }

            if (textContent == null || "\n".equals(textContent) || textContent.isEmpty()) {
